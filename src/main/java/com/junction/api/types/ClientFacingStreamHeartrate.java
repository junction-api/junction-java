...
public final class ClientFacingStreamHeartrate {
    ...
    public <T> T visit(Visitor<T> visitor) {
        if (this.type == 0) {
            return visitor.visitListOfOptionalNullableInteger((List<Optional<Integer>>) this.value);
        } else if (this.type == 1) {
    ...
    public static ClientFacingStreamHeartrate ofListOfOptionalNullableInteger(List<Optional<Integer>> value) {
    ...
    public interface Visitor<T> {
        T visitListOfOptionalNullableInteger(List<Optional<Integer>> value);
    ...
    static final class Deserializer extends StdDeserializer<ClientFacingStreamHeartrate> {
        ...
        public ClientFacingStreamHeartrate deserialize(JsonParser p, DeserializationContext context)
            ...
            try {
                return ofListOfOptionalNullableInteger(
