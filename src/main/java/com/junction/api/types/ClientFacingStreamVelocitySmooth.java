...
public final class ClientFacingStreamVelocitySmooth {
    ...
    public <T> T visit(Visitor<T> visitor) {
        if (this.type == 0) {
            return visitor.visitListOfOptionalNullableDouble((List<Optional<Double>>) this.value);
        } else if (this.type == 1) {
    ...
    public static ClientFacingStreamVelocitySmooth ofListOfOptionalNullableDouble(List<Optional<Double>> value) {
    ...
    public interface Visitor<T> {
        T visitListOfOptionalNullableDouble(List<Optional<Double>> value);
    ...
    static final class Deserializer extends StdDeserializer<ClientFacingStreamVelocitySmooth> {
        ...
        public ClientFacingStreamVelocitySmooth deserialize(JsonParser p, DeserializationContext context)
            ...
            try {
                return ofListOfOptionalNullableDouble(
