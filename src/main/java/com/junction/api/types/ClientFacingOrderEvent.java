...
public final class ClientFacingOrderEvent {
    ...
    private Optional<OrderStatusDetail> _getStatusDetail() {
        return statusDetail;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage statusDetail(Nullable<OrderStatusDetail> statusDetail);
    }
    ...
    public static final class Builder implements IdStage, CreatedAtStage, StatusStage, _FinalStage {
         ...
         */
        @java.lang.Override
        public _FinalStage statusDetail(Nullable<OrderStatusDetail> statusDetail) {
            if (statusDetail.isNull()) {
                this.statusDetail = null;
            } else if (statusDetail.isEmpty()) {
                this.statusDetail = Optional.empty();
            } else {
                this.statusDetail = Optional.of(statusDetail.get());
            }
            return this;
        }
