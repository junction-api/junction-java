...
public final class ClientFacingOrder {
    ...
    private Optional<String> _getClinicalNotes() {
        return clinicalNotes;
    }
    ...
    private Optional<ClientFacingOrderTransaction> _getOrderTransaction() {
        return orderTransaction;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage clinicalNotes(Nullable<String> clinicalNotes);
        ...
        _FinalStage orderTransaction(Nullable<ClientFacingOrderTransaction> orderTransaction);
    }
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public _FinalStage orderTransaction(Nullable<ClientFacingOrderTransaction> orderTransaction) {
            if (orderTransaction.isNull()) {
                this.orderTransaction = null;
            } else if (orderTransaction.isEmpty()) {
                this.orderTransaction = Optional.empty();
            } else {
                this.orderTransaction = Optional.of(orderTransaction.get());
            }
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage clinicalNotes(Nullable<String> clinicalNotes) {
            if (clinicalNotes.isNull()) {
                this.clinicalNotes = null;
            } else if (clinicalNotes.isEmpty()) {
                this.clinicalNotes = Optional.empty();
            } else {
                this.clinicalNotes = Optional.of(clinicalNotes.get());
            }
            return this;
        }
