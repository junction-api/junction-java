...
@JsonDeserialize(builder = ClientFacingOrderTrackingChanged.Builder.class)
public final class ClientFacingOrderTrackingChanged {
    ...
    private final OrderTracking data;

    private final Map<String, Object> additionalProperties;

    private ClientFacingOrderTrackingChanged(
            String userId,
            String clientUserId,
            String teamId,
            OrderTracking data,
    ...
    public String getEventType() {
        return "labtest.order_tracking.updated";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingOrderTrackingChanged && equalTo((ClientFacingOrderTrackingChanged) other);
    }
    ...
    private boolean equalTo(ClientFacingOrderTrackingChanged other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingOrderTrackingChanged other);
    }
    ...
    public interface DataStage {
        _FinalStage data(@NotNull OrderTracking data);
    }

    public interface _FinalStage {
        ClientFacingOrderTrackingChanged build();
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingOrderTrackingChanged other) {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull OrderTracking data) {
            this.data = Objects.requireNonNull(data, "data must not be null");
            return this;
        }

        @java.lang.Override
        public ClientFacingOrderTrackingChanged build() {
            return new ClientFacingOrderTrackingChanged(userId, clientUserId, teamId, data, additionalProperties);
        }
