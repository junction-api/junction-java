...
public final class PatientAddressCompatible {
    ...
    private Optional<String> _getAccessNotes() {
        return accessNotes;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage accessNotes(Nullable<String> accessNotes);
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public _FinalStage accessNotes(Nullable<String> accessNotes) {
            if (accessNotes.isNull()) {
                this.accessNotes = null;
            } else if (accessNotes.isEmpty()) {
                this.accessNotes = Optional.empty();
            } else {
                this.accessNotes = Optional.of(accessNotes.get());
            }
            return this;
        }
