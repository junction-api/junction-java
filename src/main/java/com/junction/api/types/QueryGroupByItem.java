...
public final class QueryGroupByItem {
    ...
    public static QueryGroupByItem of(ReliabilityColumnExpr value) {
    ...
    public static QueryGroupByItem of(SourceColumnExpr value) {
        return new QueryGroupByItem(value, 24);
    }
    ...
    static final class Deserializer extends StdDeserializer<QueryGroupByItem> {
        ...
        public QueryGroupByItem deserialize(JsonParser p, DeserializationContext context) throws IOException {
            ...
            if (value instanceof Map<?, ?>
                    && ((Map<?, ?>) value).containsKey("date_trunc")
            ...
            if (value instanceof Map<?, ?>
                    && ((Map<?, ?>) value).containsKey("arg")
                    && ((Map<?, ?>) value).containsKey("date_part")) {
                try {
