...
public final class QuerySelectItem {
    ...
    public static QuerySelectItem of(ReliabilityColumnExpr value) {
    ...
    public static QuerySelectItem of(SourceColumnExpr value) {
        return new QuerySelectItem(value, 26);
    }
    ...
    static final class Deserializer extends StdDeserializer<QuerySelectItem> {
        ...
        public QuerySelectItem deserialize(JsonParser p, DeserializationContext context) throws IOException {
            ...
            if (value instanceof Map<?, ?>
                    && ((Map<?, ?>) value).containsKey("arg")
                    && ((Map<?, ?>) value).containsKey("func")) {
                try {
                    return of(ObjectMappers.JSON_MAPPER.convertValue(value, AggregateExpr.class));
                } catch (RuntimeException e) {
                }
            }
            if (value instanceof Map<?, ?> && ((Map<?, ?>) value).containsKey("group_key")) {
                try {
                    return of(ObjectMappers.JSON_MAPPER.convertValue(value, GroupKeyColumnExpr.class));
                } catch (RuntimeException e) {
                }
            }
            if (value instanceof Map<?, ?> && ((Map<?, ?>) value).containsKey("sleep")) {
                try {
            ...
            if (value instanceof Map<?, ?>
                    && ((Map<?, ?>) value).containsKey("timeseries")
                    && ((Map<?, ?>) value).containsKey("field")) {
                try {
            ...
            if (value instanceof Map<?, ?> && ((Map<?, ?>) value).containsKey("field")) {
                try {
            ...
            if (value instanceof Map<?, ?>
                    && ((Map<?, ?>) value).containsKey("select")
                    && ((Map<?, ?>) value).containsKey("from")) {
                try {
                    return of(ObjectMappers.JSON_MAPPER.convertValue(value, ScalarOutputSubqueryExpr.class));
                } catch (RuntimeException e) {
                }
            }
            if (value instanceof Map<?, ?> && ((Map<?, ?>) value).containsKey("source")) {
                try {
