...
@JsonDeserialize(builder = MatchReviewLab.Builder.class)
public final class MatchReviewLab {
    ...
    private MatchReviewLab(int id, String name, String slug, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
        this.slug = slug;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MatchReviewLab && equalTo((MatchReviewLab) other);
    }
    ...
    private boolean equalTo(MatchReviewLab other) {
    ...
    public interface IdStage {
        ...
        Builder from(MatchReviewLab other);
    }
    ...
    public static final class Builder implements IdStage, NameStage, SlugStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(MatchReviewLab other) {
            id(other.getId());
            name(other.getName());
            slug(other.getSlug());
            return this;
        ...
        @java.lang.Override
        public MatchReviewLab build() {
            return new MatchReviewLab(id, name, slug, additionalProperties);
        }
