...
public final class ClientFacingSleep {
    ...
    public Optional<Integer> getRecoveryReadinessScore() {
        if (recoveryReadinessScore == null) {
            return Optional.empty();
        }
    ...
    private Optional<Integer> _getRecoveryReadinessScore() {
        return recoveryReadinessScore;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage recoveryReadinessScore(Nullable<Integer> recoveryReadinessScore);
    ...
    public static final class Builder
         ...
         */
        @java.lang.Override
        public _FinalStage recoveryReadinessScore(Nullable<Integer> recoveryReadinessScore) {
            if (recoveryReadinessScore.isNull()) {
                this.recoveryReadinessScore = null;
            } else if (recoveryReadinessScore.isEmpty()) {
                this.recoveryReadinessScore = Optional.empty();
            } else {
                this.recoveryReadinessScore = Optional.of(recoveryReadinessScore.get());
            }
            return this;
        }
