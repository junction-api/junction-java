...
public class RawTestkitClient {
    ...
    public JunctionHttpResponse<PostOrderResponse> register(RegisterTestkitRequest request) {
        return register(request, null);
    }

    public JunctionHttpResponse<PostOrderResponse> register(
     ...
     */
    public JunctionHttpResponse<PostOrderResponse> createOrder(CreateRegistrableTestkitOrderRequest request) {
