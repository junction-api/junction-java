...
public class AsyncRawTestkitClient {
    ...
    public CompletableFuture<JunctionHttpResponse<PostOrderResponse>> register(RegisterTestkitRequest request) {
        return register(request, null);
    }

    public CompletableFuture<JunctionHttpResponse<PostOrderResponse>> register(
