...
public class RawLabReportClient {
     ...
     */
    public JunctionHttpResponse<ParsingJob> parserCreateJob(File file, CreateLabReportParserJobBody request) {
     ...
     * and starts the ParseLabReport. Returns a generated job_id.
     */
    public JunctionHttpResponse<ParsingJob> parserCreateJob(
     ...
     */
    public JunctionHttpResponse<ParsingJob> parserGetJob(String jobId) {
     ...
     * ParseLabResultJobResponse with job status and parsed data (if complete)</p>
     */
    public JunctionHttpResponse<ParsingJob> parserGetJob(String jobId, RequestOptions requestOptions) {
     ...
     * ParseLabResultJobResponse with job status and parsed data (if complete)</p>
     */
    public JunctionHttpResponse<ParsingJob> parserGetJob(String jobId, ParserGetJobLabReportRequest request) {
     ...
     * ParseLabResultJobResponse with job status and parsed data (if complete)</p>
     */
    public JunctionHttpResponse<ParsingJob> parserGetJob(
