...
public class RawMenstrualCycleClient {
    ...
    public JunctionHttpResponse<MenstrualCycleResponse> get(String userId, GetMenstrualCycleRequest request) {
        return get(userId, request, null);
    }

    public JunctionHttpResponse<MenstrualCycleResponse> get(
