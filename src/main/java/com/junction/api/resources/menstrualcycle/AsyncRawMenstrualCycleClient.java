...
public class AsyncRawMenstrualCycleClient {
    ...
    public CompletableFuture<JunctionHttpResponse<MenstrualCycleResponse>> get(
    ...
    public CompletableFuture<JunctionHttpResponse<MenstrualCycleResponse>> get(
        ...
        CompletableFuture<JunctionHttpResponse<MenstrualCycleResponse>> future = new CompletableFuture<>();
