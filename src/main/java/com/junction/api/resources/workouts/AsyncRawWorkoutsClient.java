...
public class AsyncRawWorkoutsClient {
     ...
     */
    public CompletableFuture<JunctionHttpResponse<ClientWorkoutResponse>> get(
            String userId, GetWorkoutsRequest request) {
    ...
    public CompletableFuture<JunctionHttpResponse<ClientWorkoutResponse>> get(
        ...
        CompletableFuture<JunctionHttpResponse<ClientWorkoutResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<JunctionHttpResponse<RawWorkoutResponse>> getRaw(
            String userId, GetRawWorkoutsRequest request) {
    ...
    public CompletableFuture<JunctionHttpResponse<RawWorkoutResponse>> getRaw(
        ...
        CompletableFuture<JunctionHttpResponse<RawWorkoutResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<JunctionHttpResponse<ClientFacingStream>> getByWorkoutId(String workoutId) {
        return getByWorkoutId(workoutId, GetByWorkoutIdWorkoutsRequest.builder().build());
    }

    public CompletableFuture<JunctionHttpResponse<ClientFacingStream>> getByWorkoutId(
    ...
    public CompletableFuture<JunctionHttpResponse<ClientFacingStream>> getByWorkoutId(
        ...
        CompletableFuture<JunctionHttpResponse<ClientFacingStream>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
