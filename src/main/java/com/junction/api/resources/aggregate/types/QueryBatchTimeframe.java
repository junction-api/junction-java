 ...
 */
package com.junction.api.resources.aggregate.types;
...
import com.junction.api.types.Placeholder;
import com.junction.api.types.RelativeTimeframe;
    ...
    static final class Deserializer extends StdDeserializer<QueryBatchTimeframe> {
        ...
        public QueryBatchTimeframe deserialize(JsonParser p, DeserializationContext context) throws IOException {
            ...
            if (value instanceof Map<?, ?>
                    && ((Map<?, ?>) value).containsKey("anchor")
                    && ((Map<?, ?>) value).containsKey("past")) {
                try {
