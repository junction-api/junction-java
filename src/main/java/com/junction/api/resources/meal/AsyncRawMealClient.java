...
public class AsyncRawMealClient {
     ...
     * Get user's meals
     */
    public CompletableFuture<JunctionHttpResponse<ClientFacingMealResponse>> get(
            String userId, GetMealRequest request) {
    ...
    public CompletableFuture<JunctionHttpResponse<ClientFacingMealResponse>> get(
        ...
        CompletableFuture<JunctionHttpResponse<ClientFacingMealResponse>> future = new CompletableFuture<>();
