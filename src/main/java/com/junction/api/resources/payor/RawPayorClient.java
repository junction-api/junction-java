...
public class RawPayorClient {
    ...
    public JunctionHttpResponse<ClientFacingPayor> createPayor(CreatePayorBody request) {
        return createPayor(request, null);
    }

    public JunctionHttpResponse<ClientFacingPayor> createPayor(CreatePayorBody request, RequestOptions requestOptions) {
