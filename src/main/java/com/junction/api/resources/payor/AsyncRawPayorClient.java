...
public class AsyncRawPayorClient {
    ...
    public CompletableFuture<JunctionHttpResponse<ClientFacingPayor>> createPayor(CreatePayorBody request) {
        return createPayor(request, null);
    }

    public CompletableFuture<JunctionHttpResponse<ClientFacingPayor>> createPayor(
        ...
        CompletableFuture<JunctionHttpResponse<ClientFacingPayor>> future = new CompletableFuture<>();
