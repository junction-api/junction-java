...
public class RawSleepCycleClient {
     ...
     */
    public JunctionHttpResponse<ClientSleepCycleResponse> get(String userId, GetSleepCycleRequest request) {
     ...
     * Get sleep cycle for user_id
     */
    public JunctionHttpResponse<ClientSleepCycleResponse> get(
