...
public class RawActivityClient {
     ...
     */
    public JunctionHttpResponse<ClientActivityResponse> get(String userId, GetActivityRequest request) {
     ...
     * Get activity summary for user_id
     */
    public JunctionHttpResponse<ClientActivityResponse> get(
     ...
     */
    public JunctionHttpResponse<RawActivityResponse> getRaw(String userId, GetRawActivityRequest request) {
     ...
     * Get raw activity summary for user_id
     */
    public JunctionHttpResponse<RawActivityResponse> getRaw(
