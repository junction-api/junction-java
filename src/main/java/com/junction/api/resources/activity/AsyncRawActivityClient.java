...
public class AsyncRawActivityClient {
     ...
     */
    public CompletableFuture<JunctionHttpResponse<ClientActivityResponse>> get(
            String userId, GetActivityRequest request) {
     ...
     */
    public CompletableFuture<JunctionHttpResponse<RawActivityResponse>> getRaw(
            String userId, GetRawActivityRequest request) {
