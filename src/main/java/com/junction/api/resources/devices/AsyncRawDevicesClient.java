...
public class AsyncRawDevicesClient {
     ...
     */
    public CompletableFuture<JunctionHttpResponse<RawDevicesResponse>> getRaw(String userId) {
     ...
     * Get Devices for user_id
     */
    public CompletableFuture<JunctionHttpResponse<RawDevicesResponse>> getRaw(
     ...
     */
    public CompletableFuture<JunctionHttpResponse<RawDevicesResponse>> getRaw(
            String userId, GetRawDevicesRequest request) {
    ...
    public CompletableFuture<JunctionHttpResponse<RawDevicesResponse>> getRaw(
        ...
        CompletableFuture<JunctionHttpResponse<RawDevicesResponse>> future = new CompletableFuture<>();
