...
public class AsyncRawSleepClient {
     ...
     */
    public CompletableFuture<JunctionHttpResponse<ClientSleepResponse>> get(String userId, GetSleepRequest request) {
     ...
     * Get sleep summary for user_id
     */
    public CompletableFuture<JunctionHttpResponse<ClientSleepResponse>> get(
        ...
        CompletableFuture<JunctionHttpResponse<ClientSleepResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<JunctionHttpResponse<RawSleepResponse>> getRaw(String userId, GetRawSleepRequest request) {
     ...
     * Get raw sleep summary for user_id
     */
    public CompletableFuture<JunctionHttpResponse<RawSleepResponse>> getRaw(
        ...
        CompletableFuture<JunctionHttpResponse<RawSleepResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<JunctionHttpResponse<ClientFacingSleepStream>> getStreamBySleepId(String sleepId) {
     ...
     * Get Sleep stream for a user_id
     */
    public CompletableFuture<JunctionHttpResponse<ClientFacingSleepStream>> getStreamBySleepId(
    ...
    public CompletableFuture<JunctionHttpResponse<ClientFacingSleepStream>> getStreamBySleepId(
        ...
        CompletableFuture<JunctionHttpResponse<ClientFacingSleepStream>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
