...
public class RawBodyClient {
     ...
     */
    public JunctionHttpResponse<ClientBodyResponse> get(String userId, GetBodyRequest request) {
     ...
     * Get Body summary for user_id
     */
    public JunctionHttpResponse<ClientBodyResponse> get(
     ...
     */
    public JunctionHttpResponse<RawBodyResponse> getRaw(String userId, GetRawBodyRequest request) {
     ...
     * Get raw Body summary for user_id
     */
    public JunctionHttpResponse<RawBodyResponse> getRaw(
