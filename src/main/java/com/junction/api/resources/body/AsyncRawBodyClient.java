...
public class AsyncRawBodyClient {
     ...
     */
    public CompletableFuture<JunctionHttpResponse<ClientBodyResponse>> get(String userId, GetBodyRequest request) {
     ...
     * Get Body summary for user_id
     */
    public CompletableFuture<JunctionHttpResponse<ClientBodyResponse>> get(
        ...
        CompletableFuture<JunctionHttpResponse<ClientBodyResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<JunctionHttpResponse<RawBodyResponse>> getRaw(String userId, GetRawBodyRequest request) {
     ...
     * Get raw Body summary for user_id
     */
    public CompletableFuture<JunctionHttpResponse<RawBodyResponse>> getRaw(
        ...
        CompletableFuture<JunctionHttpResponse<RawBodyResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
