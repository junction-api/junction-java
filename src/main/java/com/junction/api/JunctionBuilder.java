...
public class JunctionBuilder {
     ...
     * Sets apiKey
     */
    public JunctionBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public JunctionBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public JunctionBuilder url(String url) {
     ...
     */
    public JunctionBuilder timeout(int timeout) {
     ...
     */
    public JunctionBuilder maxRetries(int maxRetries) {
     ...
     */
    public JunctionBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public JunctionBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public JunctionBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public JunctionBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public JunctionBuilder logging(LogConfig logging) {
     ...
     */
    public JunctionBuilder addHeader(String name, String value) {
    ...
    public Junction build() {
        ...
        return new Junction(buildClientOptions());
    }
}
