...
import com.junction.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncJunctionBuilder {
     ...
     * Sets apiKey
     */
    public AsyncJunctionBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncJunctionBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncJunctionBuilder url(String url) {
     ...
     */
    public AsyncJunctionBuilder timeout(int timeout) {
     ...
     */
    public AsyncJunctionBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncJunctionBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncJunctionBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncJunctionBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncJunctionBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncJunctionBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncJunctionBuilder addHeader(String name, String value) {
    ...
    public AsyncJunction build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new AsyncJunction(buildClientOptions());
    }
}
