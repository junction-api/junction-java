...
client.labTests().get(
    GetLabTestsRequest
        ...
        .name("name")
        .orderKey(GetLabTestsRequestOrderKey.PRICE)
        .orderDirection(GetLabTestsRequestOrderDirection.ASC)
        .build()
);
```
</dd>
...
client.labTests().getPaginated(
    GetPaginatedLabTestsRequest
        ...
        .status(LabTestStatus.ACTIVE)
        .name("name")
        .orderKey(GetPaginatedLabTestsRequestOrderKey.PRICE)
        .orderDirection(GetPaginatedLabTestsRequestOrderDirection.ASC)
        .build()
);
```
</dd>
...
client.labTests().getOrders(
    GetOrdersLabTestsRequest
        ...
        .orderKey(GetOrdersLabTestsRequestOrderKey.CREATED_AT)
        .orderDirection(GetOrdersLabTestsRequestOrderDirection.ASC)
        .isCritical(true)
...
<details><summary><code>client.labTests.getOrderTracking(orderId) -> OrderTracking</code></summary>
<dl>
<dd>
...
client.labTests().getOrderTracking(
    "order_id",
    GetOrderTrackingLabTestsRequest
        .builder()
        .build()
);
```
...
client.labAccount().getTeamLabAccounts(
    GetTeamLabAccountsLabAccountRequest
        .builder()
        .labAccountId("lab_account_id")
...
client.orderTransaction().getTransaction(
    "transaction_id",
    GetTransactionOrderTransactionRequest
        .builder()
        .build()
);
```
...
client.orderTransaction().getTransactionResult(
    "transaction_id",
    GetTransactionResultOrderTransactionRequest
        .builder()
        .build()
);
```
...
client.orderTransaction().getTransactionResultPdf(
    "transaction_id",
    GetTransactionResultPdfOrderTransactionRequest
        .builder()
        .build()
);
```
